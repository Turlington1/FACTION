...
local FACTION = Clockwork.faction:New("Civil Protection");

FACTION.isCombineFaction = true;
FACTION.whitelist = true;
FACTION.material = "halfliferp/factions/mpf";
FACTION.models = {
	female = {"models/police/c18_police_female.mdl"},
	male = {"models/police/c18_police.mdl"}
};

-- Called when a player's name should be assigned for the faction.
function FACTION:GetName(player, character)
	return "C08.MPF-RCT.T1."..Clockwork.kernel:ZeroNumberToDigits(math.random(1, 99999), 5);
end;
